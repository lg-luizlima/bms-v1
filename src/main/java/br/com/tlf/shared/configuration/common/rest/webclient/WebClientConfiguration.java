package br.com.tlf.shared.configuration.common.rest.webclient;


import br.com.tlf.logging.webclient.WebClientLoggingFilter;
import br.com.tlf.shared.configuration.common.rest.dto.v1.error.ExceptionErrorDetailsDTO;
import br.com.tlf.shared.configuration.common.rest.dto.v1.error.ExceptionErrorDetailsMapper;
import br.com.tlf.shared.configuration.common.rest.exceptionhandler.error.NotificationException;
...
import static br.com.tlf.core.application.ApplicationConstants.DEFAULT_CODECS_SIZE;
...
public class WebClientConfiguration {
    ...
    public static  <S> S createFacade(String url, Class<S> interfaceFacade,
        ...
        log.info("url: {}, class {}", url, interfaceFacade.getSimpleName());
